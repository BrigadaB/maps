...
public class CCheckAuthenticated implements Initiator {
    ...
    public static void detectAuthenticatedAndRedirect( Page page, Map<String, Object> args ) {
        ...
        TBLUsers tblUsers = (TBLUsers) currentSession.getAttribute( SystemConstants._Operator_Credential_Session_Key );
        ...
        if ( tblUsers != null ) {
            ...
            if ( extendedLogger != null )
                extendedLogger.logMessage( "1" , languaje.translate( "Requesting [%s] from user [%s] [%s]", strRequestPath, tblUsers.getFirstName(), strLoginDateTime ) );
        ...
        //Lo reenviamos para el home.zul
            ...
            Executions.sendRedirect( strRedirectPath ); //Lo redireccionamos al home.zul por que tiene un login válido
